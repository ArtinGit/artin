    ...
    return (
        <div className='featured'>
            <div className='container'>
                ...
                <div className='right'>
                    <a href='/coin'><div className='card'>
                        <div className='top'>
                            {/* <img src={BTC} alt='/' /> */}
                    ...
                    <a href='/coinn'><div className='card'>
                        <div className='top'>
                    ...
                    <a href='/coine'><div className='card'>
                        <div className='top'>
                    ...
                    <a href='/coind'><div className='card'>
                        <div className='top'>
                    ...
                    <a href='/coinbnb'><div className='card'>
                        <div className='top'>
                    ...
                    <a href='/coina'><div className='card'>
                        <div className='top'>
